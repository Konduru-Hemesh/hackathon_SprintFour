...
function getCoords(text: string, search: string, occurrenceIndex: number): { start: number; end: number } {
  let index = -1;
...
const docBText = 
  "CONFIDENTIAL RECORD OF INVESTIGATION\n\n" +
